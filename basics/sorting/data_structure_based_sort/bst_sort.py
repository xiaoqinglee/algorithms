def bst_sort(nums: list[int]) -> list[int]:
    ...
    def traverse(tree: BST) -> None:
        if tree.root is None:
            return
        traverse(tree.root.left)
        for i in range(tree.root.val):
            sorted_.append(tree.root.key)
...
if __name__ == "__main__":
    from basics.sorting.data_structure_based_sort.heap_sort import heap_sort
    from basics.sorting.data_structure_based_sort.skiplist_sort import skiplist_sort
